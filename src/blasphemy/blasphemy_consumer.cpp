...
{
    return [&parent_consumer, wrapper_name, object_name](std::string details, const code_position code_pos) {
...
void codesh::blasphemy::semantic_consumer(std::string details, const code_position code_pos)
{
