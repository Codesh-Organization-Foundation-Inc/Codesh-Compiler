...
extern const std::string DEST_PATH_NOT_DIRECTORY;
...
extern const std::string NOT_AN_OBJECT;
extern const std::string UNARY_TYPE_MISMATCH;
extern const std::string BINARY_TYPE_MISMATCH;
extern const std::string VARIABLE_REFERENCED_BEFORE_CREATION;
extern const std::string NOT_A_VARIABLE;
extern const std::string SYMBOL_NOT_FOUND;
extern const std::string TYPE_DOES_NOT_EXIST;
extern const std::string METHOD_NOT_FOUND;
extern const std::string NOT_A_METHOD;
extern const std::string ARGUMENT_TYPE_MISMATCH;
extern const std::string DUPLICATE_TYPE_DECLARATION;
extern const std::string DUPLICATE_METHOD_DECLARATION;
...
extern const std::string TOO_MANY_LOCAL_VARIABLES;
