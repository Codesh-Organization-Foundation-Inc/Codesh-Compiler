...
// LEXICAL
const std::string codesh::blasphemy::details::NO_BASAD = "בַּסַּ\"ד אֵינוֹ";
const std::string codesh::blasphemy::details::TOKEN_DOESNT_EXIST = "מִלָּה אֵינָהּ קַיֶּמֶת אוֹ שְׁאוּלָה מִלּוֹעֲזִית";

// SYNTAX
const std::string codesh::blasphemy::details::NO_IDENTIFIER = "נָבוֹא שְׁקָרַי: צֻּפָּה מִלָּה חָפְשִׁית";
const std::string codesh::blasphemy::details::NO_IMPORT_TYPE = "נָבוֹא שְׁקָרַי: צֻּפָּה סוּג יְבוּא";
const std::string codesh::blasphemy::details::NO_KEYWORD_LET = "נָבוֹא שְׁקָרַי: צֻּפָּה ויהי";
const std::string codesh::blasphemy::details::NO_KEYWORD_NAME = "נָבוֹא שְׁקָרַי: צֻּפָּה ושמו";
const std::string codesh::blasphemy::details::NO_CLOSE_MULTI_COMMENT = "נָבוֹא שְׁקָרַי: צֻּפָּה סְגִירַת הָעֵרָה מְרוּבַּת־פְּסוּקִים";
const std::string codesh::blasphemy::details::NO_CLOSE_PARENTHESIS = "נָבוֹא שְׁקָרַי: צֻּפָּה כי־טוב";
const std::string codesh::blasphemy::details::NO_SCOPE_BEGIN = "נָבוֹא שְׁקָרַי: צֻּפָּה ויאמר";
const std::string codesh::blasphemy::details::NO_SCOPE_END = "נָבוֹא שְׁקָרַי: צֻּפָּה ויתם";
const std::string codesh::blasphemy::details::NO_KEYWORD_SHALL_BE = "נָבוֹא שְׁקָרַי: צֻּפָּה היה";
const std::string codesh::blasphemy::details::NO_KEYWORD_BY = "נָבוֹא שְׁקָרַי: צֻּפָּה פי";
const std::string codesh::blasphemy::details::NO_KEYWORD_TO = "נָבוֹא שְׁקָרַי: צֻּפָּה עד";
const std::string codesh::blasphemy::details::NO_KEYWORD_FROM = "נָבוֹא שְׁקָרַי: צֻּפָּה מן";
const std::string codesh::blasphemy::details::NO_KEYWORD_SKIP = "נָבוֹא שְׁקָרַי: צֻּפָּה וידלג";
