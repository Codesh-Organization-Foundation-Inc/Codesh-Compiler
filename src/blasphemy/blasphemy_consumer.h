...
{
using blasphemy_consumer = std::function<void(std::string details, lexer::code_position code_pos)>;
...
void semantic_consumer(std::string details, lexer::code_position code_pos);
}
