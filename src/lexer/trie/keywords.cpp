...
const codesh::lexer::trie::keywords_map codesh::lexer::trie::KEYWORDS = {
    ...
    {token_group::KEYWORD_AS, {u"בתור־", word_boundary::BEFORE}},
    ...
    {token_group::OPERATOR_THE, {u"את", word_boundary::BOTH}},
    ...
    {token_group::KEYWORD_HIS_LENGTH, {u"ואורכו", word_boundary::BOTH}},
    {token_group::KEYWORD_ON, {u"על", word_boundary::BOTH}},
    {token_group::KEYWORD_CUBIT, {u"אמה", word_boundary::BOTH}},
