...
const std::vector<codesh::lexer::trie::keyword_info> codesh::lexer::trie::KEYWORDS = {
     ...
     {token_group::OPERATOR_TIMES, u"פי", word_boundary::BOTH},
     {token_group::OPERATOR_MODULO, u"ויושרה", word_boundary::BOTH},

     {token_group::OPERATOR_ADDITION_ASSIGNMENT, u"ויסף", word_boundary::BOTH},
     {token_group::OPERATOR_SUBTRACTION_ASSIGNMENT, u"ויחסר", word_boundary::BOTH},
     ...
     {token_group::OPEN_PARENTHESIS, u"כי", word_boundary::BOTH},
     {token_group::CLOSE_PARENTHESIS, u"פסק", word_boundary::BOTH},
    ...
    {token_group::KEYWORD_ANNOTATION, u"חותם", word_boundary::BOTH},
     ...
     {token_group::KEYWORD_IMPLEMENTS, u"וירש את", word_boundary::BOTH},
     {token_group::KEYWORD_NEW, u"ויברא", word_boundary::BOTH},
     {token_group::KEYWORD_THIS, u"אנכי", word_boundary::BOTH},

     {token_group::KEYWORD_FUNCTION, u"מעשה", word_boundary::BOTH},
     {token_group::KEYWORD_FUNCTION_CALL, u"ויעש", word_boundary::BOTH},
     {token_group::KEYWORD_FUNCTION_TAKE_ARGS, u"ויקח", word_boundary::BOTH},

     {token_group::KEYWORD_PUBLIC, u"נגלה", word_boundary::BOTH},
     {token_group::KEYWORD_PUBLIC, u"נגלית", word_boundary::BOTH},
     {token_group::KEYWORD_PRIVATE, u"נסתר", word_boundary::BOTH},
     {token_group::KEYWORD_PRIVATE, u"נסתרת", word_boundary::BOTH},
     {token_group::KEYWORD_STATIC, u"כללי", word_boundary::BOTH},
     ...
     {token_group::OPERATOR_GREATER_EQUAL, u"גדול־ושווה", word_boundary::BOTH},
     {token_group::OPERATOR_LESS, u"קטן", word_boundary::BOTH},
     {token_group::OPERATOR_LESS_EQUAL, u"קטן־ושווה", word_boundary::BOTH},
