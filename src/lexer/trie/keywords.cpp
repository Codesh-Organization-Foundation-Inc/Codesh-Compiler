...
const std::vector<codesh::lexer::trie::keyword_info> codesh::lexer::trie::KEYWORDS = {
    ...
    {token_group::KEYWORD_NUMBER_ZERO, u"חמס", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_ONE, u"אחד", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_TWO, u"שתיים", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_THREE, u"שלוש", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_FOUR, u"ארבע", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_FIVE, u"חמש", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_SIX, u"שש", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_SEVEN, u"שבע", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_EIGHT, u"שמונה", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_NINE, u"תשע", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_TEN, u"עשר", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_TWELVE, u"תריסר", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_TWENTY, u"עשרים", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_THIRTY, u"שלושים", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_FORTY, u"ארבעים", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_FIFTY, u"חמישים", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_SIXTY, u"שישים", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_SEVENTY, u"שבעים", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_EIGHTY, u"שמונים", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_NINETY, u"תשעים", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_HUNDRED, u"מאה", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_THOUSAND, u"אלף", word_boundary::BOTH},
    {token_group::KEYWORD_NUMBER_TEN_THOUSAND, u"רבבה", word_boundary::BOTH},
