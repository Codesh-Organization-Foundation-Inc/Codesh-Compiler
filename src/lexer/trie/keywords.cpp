...
const std::vector<codesh::lexer::trie::keyword_info> codesh::lexer::trie::KEYWORDS = {
     ...
     {token_group::KEYWORD_IMPORT_STATIC, "ויבא בכלל את", word_boundary::BOTH},
     {token_group::KEYWORD_IMPORT, "ויבא את", word_boundary::BOTH},
    ...
    {token_group::KEYWORD_ANNOTATION, "חותם", word_boundary::BOTH},
     ...
     {token_group::KEYWORD_FUNCTION, "מעשה", word_boundary::BOTH},
