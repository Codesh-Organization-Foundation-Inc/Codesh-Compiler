#include "multiplication_assignment_operator_ast_node.h"
...
std::string codesh::ast::op::assignment::multiplication_assignment_operator_ast_node::to_pretty_string() const
{
    return lexer::trie::TOKEN_TO_NAME_MAP.at(token_group::OPERATOR_MULTIPLICATION_ASSIGNMENT);
}

void codesh::ast::op::assignment::multiplication_assignment_operator_ast_node::emit_ir(
