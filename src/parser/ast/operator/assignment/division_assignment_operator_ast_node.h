...
{
public:
    division_assignment_operator_ast_node(lexer::code_position code_position, std::unique_ptr<var_reference::variable_reference_ast_node> left, std::unique_ptr<value_ast_node> right);
