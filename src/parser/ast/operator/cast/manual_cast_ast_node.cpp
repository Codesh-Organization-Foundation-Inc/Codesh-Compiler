        ...
        const type_decl::type_declaration_ast_node &containing_type_decl) const
{
    ...
    const auto *source_prim = dynamic_cast<type::primitive_type_ast_node *>(get_value().get_type());
    const auto *target_prim = dynamic_cast<type::primitive_type_ast_node *>(target_type.get());
