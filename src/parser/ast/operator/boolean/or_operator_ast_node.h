...
class or_operator_ast_node final : public boolean_binary_ast_node
{
public:
    or_operator_ast_node(blasphemy::code_position code_position, std::unique_ptr<value_ast_node> left,
