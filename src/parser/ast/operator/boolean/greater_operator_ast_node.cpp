...
codesh::ast::op::greater_operator_ast_node::greater_operator_ast_node(const blasphemy::code_position code_position,
...
void codesh::ast::op::greater_operator_ast_node::emit_ir(
