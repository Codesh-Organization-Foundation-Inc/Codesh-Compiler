...
class less_equals_operator_ast_node final : public boolean_binary_ast_node
{
public:
    less_equals_operator_ast_node(blasphemy::code_position code_position, std::unique_ptr<value_ast_node> left,
