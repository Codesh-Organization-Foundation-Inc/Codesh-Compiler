...
codesh::ast::op::modulu_operator_ast_node::modulu_operator_ast_node(const lexer::code_position code_position,
...
{
    return lexer::trie::token_to_string(token_group::OPERATOR_MODULO);
}
