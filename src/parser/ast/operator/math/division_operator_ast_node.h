...
class division_operator_ast_node final : public impl::binary_ast_node, public i_math_operator_holder
{
public:
    division_operator_ast_node(blasphemy::code_position code_position, std::unique_ptr<value_ast_node> left,
