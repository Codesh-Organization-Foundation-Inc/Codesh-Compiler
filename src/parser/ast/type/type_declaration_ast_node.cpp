...
codesh::ast::type::attributes_ast_node *codesh::ast::type::type_declaration_ast_node::get_attributes()
    const
{
    return this->attributes.get();
}
void codesh::ast::type::type_declaration_ast_node::set_attributes(
