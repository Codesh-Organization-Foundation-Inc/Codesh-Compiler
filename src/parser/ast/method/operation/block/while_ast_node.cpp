...
void while_ast_node::set_statement_index(const size_t statement_index)
{
    method_operation_ast_node::set_statement_index(statement_index);
    condition->set_statement_index(statement_index);
}

void while_ast_node::emit_constants(const compilation_unit_ast_node &root_node,
                                    output::jvm_target::constant_pool &constant_pool)
{
    body_scope.emit_constants(root_node, constant_pool);
}

void while_ast_node::emit_ir(output::ir::code_block &containing_block,
