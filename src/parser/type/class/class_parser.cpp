        ...
        std::queue<std::unique_ptr<token>> &tokens)
{
    ...
    {
        error::get_blasphemy_collector().add_blasphemy("נָבוֹא שְׁקָרַי: צֻּפָּה ושמו", error::blasphemy_type::SYNTAX);
    }
    ...
    if (!name_token)
    {
        error::get_blasphemy_collector().add_blasphemy("נָבוֹא שְׁקָרַי: צֻּפָּה מִלָּה חָפְשִׁית", error::blasphemy_type::SYNTAX);
    }
    ...
    {
        error::get_blasphemy_collector().add_blasphemy("נָבוֹא שְׁקָרַי: צֻּפָּה ויאמר", error::blasphemy_type::SYNTAX);
    }
        ...
        ast::type_decl::class_declaration_ast_node *const class_node)
{
    ...
    codesh::error::get_blasphemy_collector().add_blasphemy("נָבוֹא שְׁקָרַי: צֻּפָּה ויתם",
        codesh::error::blasphemy_type::SYNTAX);
}
        ...
        std::queue<std::unique_ptr<codesh::token>> &tokens)
{
    ...
    {
        codesh::error::get_blasphemy_collector().add_blasphemy("נָבוֹא שְׁקָרַי: צֻּפָּה ושמו",
            codesh::error::blasphemy_type::SYNTAX);
    }
