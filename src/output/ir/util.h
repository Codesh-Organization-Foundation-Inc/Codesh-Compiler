...
{
[[nodiscard]] std::optional<int> goc_big_int_value(const ast::var_reference::value_ast_node &rhs_value,
...
/**
 * Describes a typed local variable table entry and the operation to apply to it
 */
struct lvt_operand
{
